	...
	<div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="well well-sm">
          <form class="form-horizontal" action="index.php?page=5" method="post" onSubmit="return contactFormCheck();">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
				...
				<p style="display:none;" id="pName">Must start with capital letter</p>
              </div>
            </div>
